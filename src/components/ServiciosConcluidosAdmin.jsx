        ...
        <div className="mt-6 rounded-lg border-l-4 border-blue-600 bg-blue-50 p-6">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div>
              ...
              {selected.ficha_grooming?.foto_antes_path ? (
                <img src={photoUrl(selected.ficha_grooming.foto_antes_path)} alt="Antes" className="h-56 w-full rounded-lg object-cover" />
              ) : (
            ...
            <div>
              ...
              {selected.ficha_grooming?.foto_despues_path ? (
                <img src={photoUrl(selected.ficha_grooming.foto_despues_path)} alt="Despues" className="h-56 w-full rounded-lg object-cover" />
              ) : (
          ...
          <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-4">
              ...
              <p className="whitespace-pre-wrap text-sm text-gray-800">{selected.ficha_grooming?.insumos_texto || 'Sin registro.'}</p>
            </div>
            <div className="rounded-lg border border-gray-200 bg-white p-4">
